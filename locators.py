...
class Locators:
    ...
    MAIN_PAGE_CONSTRUCTOR_IGREDIENT_COUNTER = (By.XPATH, "//p[contains(@class, 'counter_counter__num')]")
    ...
    PROFILE_PAGE_ORDER_HISTORY_BUTTOn = (By.XPATH, "//a0[text()='История заказов']") 
    ...
    FEED_PAGE__ORDER_FEED_ITEM = (By.XPATH, "//li[contains(@class, 'OrderHistory_listItem')]")
